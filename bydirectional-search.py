...
if __name__ == '__main__':
    ...
    my_Graph.AddEdge(4, 10)
    my_Graph.AddEdge(5, 14)
    my_Graph.AddEdge(3, 6)
    my_Graph.AddEdge(3, 2)
    my_Graph.AddEdge(2, 7)
    my_Graph.AddEdge(6, 7)
    my_Graph.AddEdge(6, 12)
    my_Graph.AddEdge(7, 14)
    my_Graph.AddEdge(14, 13)
    my_Graph.AddEdge(13, 12)
    my_Graph.AddEdge(12, 8)
    my_Graph.AddEdge(8, 11)
    my_Graph.AddEdge(13, 11)
    my_Graph.AddEdge(14, 10)
